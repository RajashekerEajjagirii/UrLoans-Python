    ...
    return (
      <Stack
            ...
            <Card sx={{minWidth:{xs:575,lg:575},marginLeft:{lg:10,xs:0},background:'#f8f8f8'}}> 
                ...
                <CardContent>
                 <Typography ml={25} fontWeight={700}>Personal Loans</Typography>
                ...
                <CardActions >
                    <Button variant='contained' color='error' sx={{marginLeft:23}} LinkComponent={Link} to="/adminhome/personalloans">Close
